...
import { getTodos, doneTodo } from "../lib/actions";

type TodoItemProps = {
    item_id: number;
    description: string;
    isDone: boolean;
    onEdit: (item_id: number, description: string) => void;
...
export default function TodoItem ({item_id, description, isDone, onEdit, onRemove}: TodoItemProps){
    ...
    const [frontIsDone, setFrontIsDone] = useState(isDone);
                ...
                <div className="flex justify-between">
                    <div>
                        <input 
                            ...
                            className="m-2"
                        />
                        <span className={frontIsDone? "line-through text-gray-400": ""}>
                            {description}
                        </span>
                    </div>
                    <div>
